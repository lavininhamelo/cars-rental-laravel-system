...
<div class="pull-right">
    ...
    <a class="btn btn-success" style="margin-bottom:10px;" href="{{ route('vehicles.create') }}"> Create New Vehicle</a> @endcan
            ...
            <tbody>
                ...
                <tr class="gradeX">
                    ...
                    <td class="actions">
                        ...
                        <a class="btn btn-warning btn-xs" href="#"><i class="icon-edit"></i></a>

                        <form action="{{ route('vehicles.destroy', $vehicle->id)}}" method="post">

                            <a class="btn btn-danger btn-xs" href="#" data-toggle="modal" data-target="#delete-modal"><i
